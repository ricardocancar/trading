...
class CrossoverStrategy(BaseStrategy):
    ...
    def generate_signals(self, indicator:BaseIndicator, mode:Enum, column_indicator:str='Close'):
        ...
        self.data['short_period'] = indicator_instance.calculate(self.short_period, mode=mode)
        self.data['long_period'] = indicator_instance.calculate(self.long_period, mode=mode)
